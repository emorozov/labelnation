...
sub set_parameters_for_type ()
{
  ...
  elsif ($ntype eq "avery5168")
  {
    # Big shipping labels, 4 per page
    $params[0] = 31;              # Left_Margin
    $params[1] = 33;              # Bottom_Margin
    $params[2] = 254;             # Label_Width
    $params[3] = 363;             # Label_Height
    $params[4] = 37;              # Horiz_Space
    $params[5] = 0;               # Vert_Space
    $params[6] = 2;               # Horiz_Num_Labels
    $params[7] = 2;               # Vert_Num_Labels
    $params[8] = "Times-Roman";   # Font_Name
    $params[9] = 12;              # Font_Size
  }
...
sub types ()
{
  ...
  print "\n";
  print "   Avery-5168                             (4 labels per page)\n";
  print "\n";
